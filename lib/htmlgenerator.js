...
exports.getHtmlInterval = (html, req) => {
...
exports.getMenu = (html, req) => {
    const params = qs.getQueryParameters(req);
    const dir = `${getDirectory()}/${params.interval}`;
...
exports.repFile = async (html, req, date) => {
    const params = qs.getQueryParameters(req);
    const dir = `${getDirectory()}/${params.interval}/${date}`;
